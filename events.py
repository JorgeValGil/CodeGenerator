...
class Eventos:
    ...
    def cargar_tipos_barcodes(self):
        tipos = ['QR', 'EAN-13', 'EAN-8', 'EAN14', 'UPC-A', 'ISBN-13', 'ISBN-10']
    ...
    def code_qr(self, code):
        my_code = qrcode.make(code)
        Eventos.process(self, my_code, True)
    ...
    def process(self, my_code, qr=False):
